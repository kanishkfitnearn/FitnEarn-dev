...
import storeHeader from "../../../public/storeHeader.png";
...
const FitnearnStore = () => {
  ...
  const visibleCards3= showAllCards ? CardsData3: CardsData3.slice(0,3);
  const visibleCards = showAllCards ? CardsData : CardsData.slice(0, 3);

  const router = useRouter();
  const navigateToStore = () => {
    router.push(`/store/YogaMat`);
  };
  const [showAllCards1, setShowAllCards1] = useState(false); // State to toggle visibility

  const toggleCardVisibility1 = () => {
    setShowAllCards1((prev) => !prev);
  };

  const visibleCards1 = showAllCards1 ? CardsData1 : CardsData1.slice(0, 3);
  const [showAllCards2, setShowAllCards2] = useState(false); // State to toggle visibility

  const toggleCardVisibility2 = () => {
    setShowAllCards2((prev) => !prev);
  };

  const visibleCards2 = showAllCards2 ? CardsData2 : CardsData2.slice(0, 3);
  ...
  return (
    <div className="pt-[72px] md:pt-[72px]">
      ...
      <div className="hidden md:h-[91px] bg-[#171717] z-50 sticky top-[70px] md:flex w-full justify-center items-center pl-[120px] pr-[60px] border-y-[1.5px] border-y-[#262626] py-4">
        <div className="w-[1200px] max-w-[1200px] flex justify-between items-center">
          ...
          <div className="flex gap-7">
            ...
            <div className="flex w-[200px] h-[46px] justify-center items-center gap-3 border-[1px] border-solid border-[#FFF] rounded-[8px]">
      ...
      <MidHeadingAnimation head4="Products" head1="Product Categories" head2="Product Categories" />
      <div className="flex flex-col justify-center items-center mt-10 mb-20 space-y-8">
        <div className="flex justify-between w-[83%]">
          <h1 className="text-white text-3xl font-bold">Yoga Mat</h1>
          <Link
        ...
        {/* <button
              className="primaryButton py-2 px-3 text-[12px] text-[#FFFFFF] font-medium leading-[18px]"
      ...
      <div className="flex flex-col justify-center items-center mt-10 mb-20 space-y-8">
        <div className="flex justify-between w-[83%]">
          <h1 className="text-white text-3xl font-bold">Dumbell</h1>
          <Link
            className="text-neutral-300 cursor-pointer"
            href={"/store/Dumbell"}
          >
      ...
      <div className="flex flex-col justify-center items-center mt-10 mb-20 space-y-8">
        <div className="flex justify-between w-[83%]">
          <h1 className="text-white text-3xl font-bold">Gym Bag</h1>
          <Link
            className="text-neutral-300 cursor-pointer"
            href={"/store/GymBag"}
          >
        ...
        <button className="primaryButton py-2 px-3 text-[12px] text-[#FFFFFF] font-medium leading-[18px]">
          View More
        </button>
        {/* <button
              className="primaryButton py-2 px-3 text-[12px] text-[#FFFFFF] font-medium leading-[18px]"
