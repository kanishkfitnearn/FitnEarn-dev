...
const LikeButtonForBlog: React.FC<LikeBlogButtonProps> = ({
  blogId,
  initialLiked,
}) => {
  // //console.log("blogid and initial like status: ", blogId, initialLiked);
  ...
  return (
    ...
    >
      {liked ? (
        ...
        //   <path d="M29.0454 9.68481C28.3427 7.06081 26.2747 4.99281 23.652 4.29014C21.0827 3.60481 18.3533 4.30081 16.0027 6.20614C14.288 4.80481 12.388 4.04614 10.448 4.00081C8.34002 3.97147 6.37335 4.74347 4.89068 6.22481C2.10268 9.01281 1.49468 14.0475 5.72402 18.2768L15.0573 27.6101C15.3173 27.8701 15.6587 28.0008 16 28.0008C16.3413 28.0008 16.6827 27.8701 16.9427 27.6101L26.276 18.2768C28.8174 15.7355 29.8267 12.6035 29.0454 9.68481Z" fill="#FCE96A" />
        // </svg>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
...
export default LikeButtonForBlog;
