      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.success) {
            router.push(`/username?selectedPic=${focusedImage}`);
          }
        })
        .catch((error) => {
          setIsAdded(false);
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <button
        ...
        className="primaryButton w-[270px] md:w-[393px] h-[43px] rounded-[8px] py-2 flex justify-center items-center text-[18px] text-[#DADADA] font-semibold leading-normal mt-8"
      >
