...
import LikeBtnForDetailedBlogForMobile from "./DetailedBlogLikeBtnForMobile";
...
const CommentShareAndReportMobile: React.FC<CommentProps> = ({
  blogId,
  initialLiked,
  likeCount,
  shareCount,
  ...
  return (
    <div className="block mt-3 md:hidden">
      <div className="py-3 md:py-[22px] w-full flex justify-between items-center comment-section mb-[20px] px-2 gap-[20px] md:gap-0">
        <div className="flex gap-5 md:gap-[48px]">
          <div className="flex items-center justify-center gap-2 cursor-pointer">
            <LikeBtnForDetailedBlogForMobile
              blogId={blogId}
          ...
          >
            ...
            >
              <path
                ...
                stroke="url(#paint0_linear_5730_57308)"
                strokeWidth="2"
                strokeLinecap="round"
        ...
        <div className="flex gap-5 md:gap-[48px]">
          <Dialog open={dialogOpenForBlog} onOpenChange={setDialogOpenForBlog}>
              ...
              <div className="flex items-center justify-center gap-2 cursor-pointer">
                ...
                >
                  <path
                    ...
                    fill="url(#paint0_linear_5730_57312)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_5730_57312"
                      x1="3.07692"
                      y1="19.3192"
                      x2="28.8078"
                      y2="19.3233"
                ...
                >
                  <path
                    ...
                    fill="url(#paint0_linear_4993_31999)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_4993_31999"
                      x1="4.42308"
                      y1="14.8511"
                      x2="20.5049"
                      y2="14.8534"
            ...
            <DialogContent className="report-dialog ">
              <DialogHeader>
                ...
                <DialogDescription className="flex flex-col items-center justify-center pt-4 mb:pt-6">
                  <div className="w-full h-[1px] bg-[#737373]"></div>
                  <h2 className="text-[24px] md:text-[32px] text-[#FFFFFF] font-bold leading-normal mt-3 mb-2">
                    Report Your Issue
                  </h2>
                  ...
                  <Textarea
                    className="h-[120px] md:h-[148px] w-[280px] md:w-auto bg-[#171717] text-white p-[10px] my-3"
                    placeholder="Enter your text here..."
                    onChange={(e) => setReportText(e.target.value)}
                  />
                  <Button
                    onClick={handleReport}
                    className="primaryButton w-[278px] md:w-[327px] text-[14px] text-[#FFFFFF] font-medium leading-[21px]"
                  >
                    Submit
                  </Button>
                </DialogDescription>
          ...
          <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
            <PopoverTrigger className="flex items-center justify-center gap-2 cursor-pointer">
              ...
              >
                <path
                  ...
                  fill="url(#paint0_linear_5730_57315)"
                />
                <path
                  ...
                  fill="url(#paint1_linear_5730_57315)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_5730_57315"
                    x1="1.64233"
                    y1="18.5829"
                    x2="30.2322"
                    y2="18.5895"
            ...
            <PopoverContent className="w-auto bg-[#262626] border-solid border-[1px] border-[#404040] rounded-[16px] p-3">
              ...
              <div className="flex gap-4">
                ...
                >
                  ...
                  <span className="text-[14px] text-[#F5F5F5] font-normal leading-[27px]">
                    WhatsApp
                  </span>
                </Link>
                <Link
              ...
              <div className="relative mt-6">
                <Input
                  ...
                  value={blogUrl}
                  readOnly
                  className="h-[45px] bg-[#404040] border-solid border-[1px] border-[#525252] rounded-[8px] p-2 text-white"
                />
                <CopyToClipboard text={blogUrl} onCopy={handleCopy}>
                  <Button className="h-[28px] absolute primaryButton top-[9px] right-2">
        ...
        <div className="mt-2 ">
          <div className="h-[150px] relative">
            <div
              ...
              onInput={handleInput}
              ref={commentBoxRef}
              className="h-[150px] text-[15px] text-white #171717 bg-[#171717] border-[2px] border-transparent rounded-[7px] pt-2 px-2 focus:outline-none custom-gradient-border"
              style={{
                borderRadius: "7px",
            ...
            {showPlaceholder && (
              <div
                className="absolute top-0 left-0 pt-2 px-2 text-[16px] text-[#A3A3A3] font-normal pointer-events-none"
                style={{ userSelect: "none" }}
              >
                Post Your comment
              </div>
            )}
            <div className="absolute bottom-0 flex items-baseline justify-end w-full mx-6">
              ...
              <button
                className="w-[65px] h-[34px] primaryButton text-white text-[12px] filterBtn border-[1px] border-[#F43F5E] rounded-[8px] mr-[36px] mb-2"
                ...
                .map((comment, index) => (
                  <div key={comment._id}>
                    <div className="flex items-center justify-start gap-2 mb-1">
                      ...
                      <span className="text-[20px] md:text-[22px] text-[#D4D4D4] font-semibold md:font-medium leading-normal">
                        {comment.userName}
                      </span>
                    </div>
                    {/* <p
                      className="text-[16px] md:text-[24px] text-[#A3A3A3] font-normal leading-normal md:leading-[34px]"
                      key={index}
                    >
                      {comment.comment}
                    </p> */}
                    ...
                    <div className="flex justify-between mt-2">
                      <div className="flex gap-5">
                        <div className="flex gap-1">
                          ...
                          />
                          <span className="text-[16px] md:text-[19px] text-[#737373] font-semibold leading-normal">
                            Like
                          </span>
                        </div>
                        <div
                      ...
                      <div className="flex gap-1 pr-3">
                        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                          ...
                          <DialogContent className="report-dialog">
                            <DialogHeader>
                              <DialogTitle></DialogTitle>
                              <DialogDescription className="flex flex-col items-center justify-center pt-4">
                                <h2 className="text-[28px] text-[#FFFFFF] font-bold leading-normal mb-1">
                                  Report Your Issue
                                </h2>
                                <h5 className="text-[18px] text-[#F5F5F5] font-semibold leading-normal mb-4">
                                  Please share what issue you are facing?
                                </h5>

                                <div className="flex flex-col items-start justify-start w-full space-y-3">
                                  <label className="flex justify-start items-center gap-[12px] text-[16px] text-[#F5F5F5] font-semibold leading-normal">
                                    <input
                                      type="radio"
                                      value="nudity or sexual activity"
                                      className="w-[20px] h-[20px] text-orange-500 bg-[#171717] border-gray-300 focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                      checked={
                                        selectedIssue ===
                    ...
                    {replyingComments[comment._id] && (
                      <div className="reply-section">
                        <div className="w-full bg-[#171717] rounded-[7px] border-[2px] custom-gradient-border p-3 mt-2">
                          <div className="flex items-start justify-start w-full gap-3">
                            ...
                            <textarea
                              ...
                              className="reply-textarea w-full h-[50px] text-[14px] text-white bg-[#171717] border-none focus:border-none focus:outline-none focus:ring-0 pt-1"
                          ...
                          <div className="relative flex items-center justify-between">
                            ...
                            <div className="flex items-center justify-center gap-2">
                              <button
                                className="w-[70px] text-[#FFFFFF] text-[12px] font-medium leading-[21px] py-2 px-3"
                                onClick={() => handleCancel(comment._id)}
                              >
                                Cancel
                              </button>
                              <button
                                className={`${focus ? "primaryButton text-bold" : "border-[1px] border-[#A3A3A3]"} rounded-[8px]  w-[70px] text-[#FFFFFF] text-[12px] font-medium leading-[21px] py-2 px-3`}
                        ...
                        {/* <div>
                          {comment.replies.map((reply) => (
                            <p
                              key={reply._id}
                              className="text-[14px] text-[#A3A3A3] font-normal leading-[28px]"
                            >
                              {reply.comment}
                            </p>
                          ))}
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span className="mid-heading text-[16px] font-normal leading-normal">
                          {comment.replies
                            ? checkReplyLength(
                                comment._id,
                            ...
                            <div className="flex items-start gap-2.5">
                              ...
                              <div className="flex flex-col w-full gap-1 ">
                                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                  <span className="text-[14px] text-[#FAFAFA] font-semibold leading-[21px]">
                                    {replyFromComment.userName}
                                  </span>
                                </div>
                                {/* <div className="flex flex-col leading-1.5 pt-0 p-4 border-[1px] border-[#404040] bg-[#171717] rounded-e-xl rounded-es-xl dark:bg-[#171717]">
                                  <p className="text-[18px] text-[#A3A3A3] font-normal leading-[24px]  pt-1">
                                    {replyFromComment.comment}
                                  </p>
                                </div> */}
                                <CommentOrReplyWithReadMore
                          ...
                          <div key={reply._id} className="mb-3">
                            <div className="flex items-start gap-2.5">
                              ...
                              <div className="flex flex-col w-full gap-1 ">
                                ...
                                {/* <div className="flex flex-col leading-1.5 pt-0 p-4 border-[1px] border-[#404040] bg-[#171717] rounded-e-xl rounded-es-xl dark:bg-[#171717]">
                                  <p className="text-[20px] text-[#A3A3A3] font-normal leading-[28px]  py-2.5">
                                    {reply.comment}
                                  </p>
                                </div> */}
                                <CommentOrReplyWithReadMore
...
export default CommentShareAndReportMobile;
