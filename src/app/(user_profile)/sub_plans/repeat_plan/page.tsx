...
const Page = () => {
  ...
  const expiryDate: any = Cookies.get("repeatSubPlanValidity");
            ...
            <div className="py-4 ">
              ...
              <div className="flex items-center justify-between w-full mb-2">
                ...
                <span className="text-[18px] md:text-[20px] text-[#FFFFFF] font-normal leading-normal">
                  ₹ {Cookies.get("repeatSubPlanPrice")}
                </span>
              </div>
              <div className="flex items-center justify-between w-full mb-2">
                <span className="text-[16px] md:text-[20px] text-[#FFFFFF] font-normal leading-normal">
                ...
                <span className="text-[18px] md:text-[20px] text-[#FFFFFF] font-normal leading-normal">
                  - ₹ {Cookies.get("repeatPlanDiscountVal")}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between w-full mb-2">
                ...
                <span className="text-[18px] md:text-[20px] text-[#FFFFFF] font-normal leading-normal">
                  ₹ {Cookies.get("repeatPlanFinalPrice")}
                </span>
              </div>
            </div>
          </div>
