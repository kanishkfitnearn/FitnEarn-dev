...
const Page = () => {
  ...
  const renderButtons = (blog: any) => {
    const baseButtonStyle =
      "p-2 text-base border rounded-lg border-neutral-600  hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C] min-w-[98px]  mq450:text-sm mq450:font-medium mq450:h-[39px] mq450:py-[6px] mq450:px-2";
      ...
      case "under review":
        return (
          <>
            <button
              // onClick={requestEdit}
              className="p-2 text-sm mq450:text-center mq450:text-[12px] mq450:font-medium w-[108px] mq450:text-nowrap text-nowrap  mq450:h-[39px] mq450:text-sm mq450:px-[10px] mq450:py-[6px]  border rounded-lg border-neutral-600  hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C]"
            >
              Edit Request
            </button>
            <button
              // onClick={requestDelete}
              className="py-2   text-sm w-[108px] mq450:text-[12px] mq450:font-medium mq450:text-nowrap text-nowrap mq450:px-2 mq450:h-[39px] mq450:text-sm mq450:px-[3px] mq450:py-[6px] border rounded-lg border-neutral-600  hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C]"
            >
              Delete Request
            </button>
          </>
