...
const Page = () => {
    ...
    const fetchBlogs = async () => {
      try {
        ...
        const filteredData: any = data.filter(
          (blog: any) => blog.status === "under review",
        );
        ...
        return (
          <>
            <button
              ...
              className="p-2 w-[104px] mq450:w-[60px] mq450:h-[40px] mq450:text-sm border rounded-lg border-neutral-600  hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C]"
            >
              Delete
            </button>
      ...
      case "draft":
        return (
          <>
            <button
              // onClick={() => handleDeleteClick(blog._id)}
              className="p-2 w-[108px] mq450:w-[98px] mq450:h-[40px] mq450:text-sm border rounded-lg border-neutral-600  hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C]"
            >
              Delete
            </button>
            <Link href={`/user_blogs/create_blogs/preview_blog/${blog._id}`}>
              <button className="p-2 w-[108px] mq450:w-[60px] mq450:h-[40px] mq450:text-sm border rounded-lg border-neutral-600  hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C]">
                Edit
              </button>
            </Link>
          </>
  ...
  const [isDesktop, setIsDesktop] = useState(true); // Default to true or false based on your preference
  ...
  return (
    <>
      <div className="relative mq450:static pt-[827px] oveflow-x-hidden">
        ...
        <div
          style={{ marginLeft: isDesktop ? "12px" : "18px" }}
          className="absolute md:ml-3  w-auto text-white md:ml-[-20px] mq450: oveflow-x-hidden top-28 left-44 mq450:left-0 mq450:mt-14 mq450:w-52"
        >
          <>
              ...
              <div className="grid grid-cols-3 gap-y-7 gap-x-[-5px]   mt-5 mq450:grid-cols-1 mq450:ml-4 mq1240:gap-[30px]">
                ...
                {filteredBlogs.map((blog) => (
                  <Card
                    ...
                    className="cardComponent rounded-[16px] object-cover p-0 max-w-sm  border w-[350px] mq1050:w-[290px] mq1240:w-[320px] border-neutral-700 h-[503px] bg-neutral-900 mq450:w-[330px] "
                  ...
                  /> */}
                    ...
                    <div className="flex justify-between gap-8 mt-4 mq450:gap-6 mq450:mt-5">
                      {renderButtons(blog)}
                    </div>
                  </Card>
                ))}
