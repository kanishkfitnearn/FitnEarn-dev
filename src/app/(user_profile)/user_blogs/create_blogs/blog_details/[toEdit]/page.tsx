...
const Page = ({ params }: any) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data.success === true) {
        ...
        router.push(
          `/user_blogs/create_blogs/write_blog/${response.data.data}`,
        );
      } else {
  ...
  useEffect(() => {
    const fetchBlogData = async () => {
      const storedBlogId = Cookies.get("blog_id");
      if (!storedBlogId) {
      ...
      try {
        const response = await fetch(
          `${apiEndpoint}/api/fitnearn/web/users/blog/${storedBlogId}`,
        );
        if (!response.ok) {
    ...
    <>
      <div className="relative mq450:static  pt-[827px] ">
        ...
        <div className="absolute text-white mq450:ml-2 mq450:top-40 top-28 left-56 mq450:left-0 mq450:mt-5 mq450:w-[320x]">
          <div className="flex ">
            <p className="text-2xl font-bold mq450:ml-2 text-neutral-100">
              Write Blog
            </p>
            {/* <button
              onClick={handlesave}
          ...
          <div className="flex gap-12 p-5 mq450:flex-col mq450:gap-[0px] mq450:p-[-50px]">
            <div className="flex flex-col">
              ...
              <input
                ...
                maxLength={28}
                className="bg-neutral-800 mq450:w-auto mq1240:w-64 text-neutral-400 w-80 h-[42px] p-3 focus:outline-none focus:border-neutral-300 focus:outline-none focus:ring-0 rounded-lg border border-neutral-800 flex-col justify-start items-start gap-2.5 inline-flex"
              />
              {blogTitleErr ? (
          ...
          <div className="flex flex-col  mq450:p-[-50px] px-5 py-4">
            ...
            <input
              ...
              className="bg-neutral-800 mq450:w-auto text-neutral-400 w-full h-[42px] p-3  rounded-lg border border-neutral-800 flex-col justify-start focus:border-neutral-600 focus:outline-none focus:ring-0 items-start gap-2.5 inline-flex"
            />
            {blogHeadingErr ? (
          ...
          <button
            ...
            className="w-[111px] hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C]   mq1240:ml-[750px] hover:bg-gradient-to-l from-pink-600 to-orange-500 mq450:ml-[220px] mb-3 ml-[960px] m-0 text-sm text-nowrap h-[33px] px-3 py-1.5 rounded-lg border border-neutral-600 justify-center items-center gap-2 inline-flex"
          >
            Next
          </button>
        </div>
