        ...
        <div className="absolute text-white mq450:ml-2 mq450:top-40 top-28 left-72 mq450:left-0 mq450:mt-5 w-fit">
          ...
          {showButtons ? (
            <button
              ...
              type="submit"
              className="w-[111px] hover:bg-gradient-to-r hover:from-[#F43F5E] hover:to-[#FB923C] mq450:ml-[200px] mq1240:ml-[400px] hover:bg-gradient-to-l from-pink-600 to-orange-500 ml-[850px] m-2 text-nowrap h-[33px] px-3 py-1.5 rounded-lg border border-neutral-600 justify-center items-center gap-2 inline-flex"
            >
              Next
            </button>
          ) : (
