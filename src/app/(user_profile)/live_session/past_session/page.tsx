...
const Page = () => {
  ...
  const fetchPastSessions = async () => {
    ...
    try {
      ...
      //console.log("the past sessions are:", allSessions);
    } catch (error) {
  ...
  return (
    <>
      <div className="relative mq450:static  27px] ">
        ...
        <div className="absolute mq450:left-[9px] text-white mq450:ml-2 top-28 left-44  mq450:mt-14 w-fit mq450:pb-5">
  ...
  mq450:ml-[50px] ml-[860px] text-sm text-nowrap h-[33px] px-3 py-1.5 rounded-lg border border-neutral-600 justify-center items-center gap-2 inline-flex"
          ...
          {/* {pastSessions.length > 0 ? (
            <div>
              {pastSessions.map((session: any, index: any) => {
                <div
                  key={session._id}
                  className=" mq1240:w-[1140px]  mq450:justify-center  mq450:flex mq1050:w-[820px] mq450:flex-col mq450:h-[138px] mq450:gap-1 mq450:items-start mt-7 mq450:w-[348px] gap-32 items-center flex h-[90px] relative bg-neutral-800 rounded shadow border  border-neutral-700"
                >
                  <h2>fsdfdsfdsssssssss</h2>
                  <div className="flex px-2 mq450:py-3">
                    ...
                    <div className="flex flex-col ml-2">
                      <p className="px-2 text-xl font-bold text-neutral-200 mq450:text-lg text-nowrap font-Lato">
                        Standard Plan
                      </p>
                      <div className="w-[108px] ml-2  h-[22px] px-2.5 py-0.5 bg-neutral-700 rounded-md justify-center items-center inline-flex">
                        <div className="text-center text-orange-500 text-xs font-medium font-['Lato'] leading-[18px]">
                          {formatTime(session.dateTime)} • 1hr
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-10 text-center">
              <Image
                ...
                alt="No Session"
              />
              <p className="mt-4 text-xl">No past sessions found</p>
            </div>
          )} */}
          {pastSessions.length > 0 ? (
            <div className="space-y-4 ">
              {pastSessions.map((session: any, index: any) => (
                <Link
                  key={session._id}
                  href={`/live_session/past_session/${session._id}`}
                >
                  <div
            ...
            <div className="mx-auto mt-10 text-center  ml-[400px] mq1050:ml-60 mq450:ml-4 flex flex-col items-center justify-center">
              ...
              <div className="flex flex-col mx-auto  items-center justify-center gap-1 text-center mt-7">
                ...
                <p className="text-lg mq450:text-base font-medium text-neutral-400 font-Lato w-[470px] mq450:w-[300px]">
                  Ready to start your fitness journey? Book your first session
                  and connect with top coaches to reach your goals!
                </p>
                <a href="/workout">
                  {" "}
