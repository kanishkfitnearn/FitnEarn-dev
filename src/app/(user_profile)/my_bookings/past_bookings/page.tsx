  ...
  const fetchPastSessions = async () => {
    ...
    try {
      const response = await fetch(
        `${apiEndpoint}/api/fitnearn/web/users/session/past/${userId}`,
      );
        ...
        {data ? (
          <div className="absolute mq450:left-[10px] text-white mq450:ml-2 top-28 left-44 mq450:left-0 mq450:mt-14 w-fit mq450:pb-5">
            ...
            {pastBookings.length > 0 ? (
              <>
                {pastBookings.map((session: any, index: any) => (
                  <Link
                    key={session._id}
                    href={`/my_bookings/past_bookings/${session._id}`}
                  >
                    <div
                    ...
                    <div className="relative flex h-[90px] mt-1 items-center justify-between w-[1200px] p-4 mq450:p-2 rounded-lg bg-neutral-800 border-neutral-700 border-2 mq450:w-[330px] mq450:h-auto mq450:flex-col mq450:items-start mq450:justify-start">
                      ...
                      <button className="w-[86px]  h-[37px] px-3 py-2 rounded-lg border border-orange-500 justify-center items-center gap-2 inline-flex text-nowrap mq450:absolute mq450:top-[170px] mq450:right-10 mq450:w-[106px]">
                        Rebook
                      </button>
                    </div>
                  </Link>
            ...
            {/* <div className=" mq1240:w-[1140px]  mq450:justify-center  mq450:flex mq1050:w-[820px] mq450:flex-col mq450:h-[138px] mq450:gap-1 mq450:items-start mt-7 mq450:w-[348px] gap-32 items-center flex h-[90px] relative bg-neutral-800 rounded shadow border  border-neutral-700">
              <div className="flex px-2 mq450:py-3">
                <Image
                  className="p-[8px]   mq450:p- mq1050:h-10 mq1050:w-10 mq1050:p-2"
                  width={55}
                  quality={100}
                  height={10}
                  src="/live_video_icon.png"
                  alt="vid icon"
                />
                <div className="flex flex-col ml-2">
                  <p className="px-2 text-xl font-bold text-neutral-300 mq450:text-lg text-nowrap font-Lato">
                    Standard Plan
                  </p>
                  <div className="w-[108px] ml-2  h-[22px] px-2.5 py-0.5 bg-neutral-700 rounded-md justify-center items-center inline-flex">
                    <div className="text-center text-orange-500 text-xs font-medium font-['Lato'] leading-[18px]">
                      Delayed 10 mins
                    </div>
                  </div>
                </div>
              </div>
              <p className="text-lg font-bold mq450:ml-8 text-neutral-300 mq450:py-1 text-nowrap mq450:px-5 mq450:text-sm font-Lato">
                Session Title
              </p>
              <p className="text-lg font-md mq450:ml-8 text-neutral-300 mq450:px-5 text-nowrap mq450:text-sm font-Lato">
                Coach Name
              </p>
              <button className="w-[86px] mq1050:ml-[-80px] mq450:absolute mq450:left-[300px] mq450:top-[70px] h-[37px] px-3 py-2 rounded-lg border border-pink-600 justify-center items-center gap-2 inline-flex text-nowrap">
                Join
              </button>
              <span className="mq1050:ml-[-80px] mq450:absolute mq450:left-[250px] mq450:top-[15px] pr-5 mq450:ml-[50px]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          //       <p className="text-2xl font-semibold text-neutral-300 font-Lato">
          //         No Booked Session
          //       </p>
          //       <p className="text-lg font-medium text-neutral-300 font-Lato">
          //         Book you first now!
          //       </p>
