...
const ShareVidForDesktop = () => {
  ...
  const handleShare = (platform:any) => {
    ...
    (window as any).gtag("event", "video_Share", {
      ...
      event_videoUrl : videoUrl || "Unknown videoUrl",
  ...
  return (
    <>
      <Popover open={popoverOpen} onOpenChange={setPopoverOpen}>
        <PopoverTrigger className="flex justify-center items-center  gap-2 cursor-pointer p-0  md:py-[2px] md:mx-4">
          <span>
            <svg
...
export default ShareVidForDesktop;
